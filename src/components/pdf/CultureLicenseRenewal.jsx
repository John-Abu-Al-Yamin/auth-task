...
const CultureLicenseRenewal = ({ formNumber }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>
          استماره طلب الحصول على تراخيص مزاوله مهنه نشاط او تجديد
        </Text>
        ...
        <View>
          ...
          <View style={[styles.textcenter, styles.mt]}>
            <Text style={styles.sectionTitle}>
              ...
              اعتمادا على جل معرو في واعتمادي
            </Text>
          </View>
        ...
        <View style={[styles.borderCard, styles.textRight]}>
          ...
          <Text>لن ادفع رسوم للتراخيص حتي يوافق اولا على هذا الطلب</Text>
...
export default CultureLicenseRenewal;
