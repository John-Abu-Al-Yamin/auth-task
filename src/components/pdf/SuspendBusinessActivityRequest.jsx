...
const SuspendBusinessActivityRequest = ({ formNumber }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View>
          ...
          <View style={[styles.textcenter, styles.mt]}>
            <Text style={styles.sectionTitle}>
              اقرار : انا الموقع ادناه التفاصيل المقدمه اعلاه صحيحه و صادقه
        ...
        <View style={[styles.flexFooter, styles.mt]}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.textRight}>صوره المستفيد 4*6 </Text>
            <Text style={styles.textRight}>صوره البطاقه الشخصيه</Text>
            <Text style={styles.textRight}>رخصه مزاوله المهنه السابقه</Text>
            <Text style={styles.textRight}>افاده مكتب الضرائب</Text>
            <Text style={styles.textRight}>صوره للمحل من الداخل و الخارج</Text>
...
export default SuspendBusinessActivityRequest;
