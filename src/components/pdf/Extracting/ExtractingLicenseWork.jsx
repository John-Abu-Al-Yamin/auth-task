...
const feeItem = [
  ...
  { name: "الاجمالي", amount: "0.00", discription: "" },
  { name: "المدفوع", amount: "1110" || 0, discription: "" },
  { name: "المتبقي", amount: "0.00", discription: "" },
];
          ...
          <View style={styles.header}>
            <View style={styles.backgroundsContainer}>
              ...
              <View style={styles.backgroundLeft}>
                <Image
                  src="/logo.png" // يمكنك استخدام صورة مختلفة هنا
          ...
          <View style={{ position: "relative" }}>
            ...
            >
              ...
              <View style={{ display: "flex", flexDirection: "row", gap: 8 }}>
                ...
                >
                  <Image
                    src="/logo.png" // صورة إضافية إذا تحب
