...
const AddBusinessActivityRequest = ({ formNumber }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* العنوان الرئيسي */}
        <Text style={styles.title}>طلب اضافه نشاط</Text>
        <Text style={styles.subtitle}>
          {"LICENCE ADD APPLICATION".toUpperCase()}
        </Text>
        ...
        <View>
          ...
          <View style={styles.flex}>
            <Text>: نوع المهنه المراد اضافتها</Text>
            <View style={styles.formLine} />
          </View>
...
export default AddBusinessActivityRequest;
