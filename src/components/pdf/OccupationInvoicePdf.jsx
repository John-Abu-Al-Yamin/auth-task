...
export const OccupationInvoicePdf = ({ formNumber }) => (
  <Document>
      ...
      <View>
        ...
        <View style={[styles.textcenter, styles.mt]}>
          <Text style={styles.sectionTitle}>
            اقرار : انا الموقع بان التفاصيل المقدمه اعلاء صحيحه و صادقه اعتمادا
            علي جل معرو في واعتمادي
          </Text>
        </View>
...
export default OccupationInvoicePdf;
