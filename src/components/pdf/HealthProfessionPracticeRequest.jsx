...
const HealthProfessionPracticeRequest = ({ formNumber }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>
          طلب الحصول على ترخيص مزاولة المهن الطبيه و الصحية
        </Text>
        ...
        <Text style={[styles.textRight, styles.mt]}>
          تم مطابقه البيانات في الملف المقدم من طلب التراخيص وتعبئه الاستمارة
...
export default HealthProfessionPracticeRequest;
